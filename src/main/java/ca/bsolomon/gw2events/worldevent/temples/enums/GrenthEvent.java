...
public enum GrenthEvent {
	...
	ESCORT_GAZE("C2AB5C4C-5FAA-449B-985C-93F8E2D579C8", "7. Death Gaze Escort"),
	CANON_DEF1("B41C90F8-AF33-400E-9AD3-3DB0AFCEDC6C", "6. Canon Def"),
	ESCORT_JONES1("4B612C93-3700-43B8-B3C1-CBC64FEC0566", "5. Escort Jones DG"),
	SECURE_DG("1D1BE3D6-2F0D-4D1C-8233-812AAF261CFF", "4. Secure Death Gaze"),
	ESCORT_JONES2("C8139970-BE46-419B-B026-485A14002D44", "3. Escort Jones Cath"),
	PORTAL_SHADE("E16113B1-CE68-45BB-9C24-91523A663BCB", "2. Kill priest"),
	COVER_JONES("99254BA6-F5AE-4B07-91F1-61A9E7C51A51", "1. Jones Cleanse");
	...
	public static void formatGrenthString(EventData templeEventData,
		...
		if (escortDGStatus!=null && (escortDGStatus.equals("Active"))) {
			...
			outStatus = ESCORT_GAZE.toString();
			...
			outStatus = ESCORT_JONES1.toString();
			color = EventStateColor.PREPARATION.color();
			fontWeight = 900;
			...
			outStatus = ESCORT_JONES2.toString();
			color = EventStateColor.PREPARATION.color();
			fontWeight = 900;
			...
			outStatus = PORTAL_SHADE.toString();
			color = EventStateColor.PREPARATION.color();
			fontWeight = 900;
			...
			outStatus = COVER_JONES.toString();
